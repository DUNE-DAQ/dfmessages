...
BOOST_AUTO_TEST_CASE(SerDes_MsgPack)
{
	...
	uint8_t five = 5, six = 6, seven = 7, eight = 8, nine = 9, ten = 10, eleven = 11, twelve = 12;
	...
	BOOST_REQUIRE_EQUAL(*(static_cast<uint8_t*>(deserialized.get_fragments_ref().at(0)->get_data()) + 0), // NOLINT(build/unsigned)
		1);        // NOLINT(build/unsigned)
	BOOST_REQUIRE_EQUAL(*(static_cast<uint8_t*>(deserialized.get_fragments_ref().at(0)->get_data()) + 1), // NOLINT(build/unsigned)
		2);        // NOLINT(build/unsigned)
	BOOST_REQUIRE_EQUAL(*(static_cast<uint8_t*>(deserialized.get_fragments_ref().at(0)->get_data()) + 2), // NOLINT(build/unsigned)
		3);        // NOLINT(build/unsigned)
	BOOST_REQUIRE_EQUAL(*(static_cast<uint8_t*>(deserialized.get_fragments_ref().at(0)->get_data()) + 3), // NOLINT(build/unsigned)
		4);        // NOLINT(build/unsigned)


	BOOST_REQUIRE_EQUAL(*(static_cast<uint8_t*>(deserialized.get_fragments_ref().at(1)->get_data()) + 0), // NOLINT(build/unsigned)
		5);        // NOLINT(build/unsigned)
	BOOST_REQUIRE_EQUAL(*(static_cast<uint8_t*>(deserialized.get_fragments_ref().at(1)->get_data()) + 1), // NOLINT(build/unsigned)
		6);        // NOLINT(build/unsigned)
	BOOST_REQUIRE_EQUAL(*(static_cast<uint8_t*>(deserialized.get_fragments_ref().at(1)->get_data()) + 2), // NOLINT(build/unsigned)
		7);        // NOLINT(build/unsigned)
	BOOST_REQUIRE_EQUAL(*(static_cast<uint8_t*>(deserialized.get_fragments_ref().at(1)->get_data()) + 3), // NOLINT(build/unsigned)
		8);        // NOLINT(build/unsigned)
	BOOST_REQUIRE_EQUAL(*(static_cast<uint8_t*>(deserialized.get_fragments_ref().at(1)->get_data()) + 4), // NOLINT(build/unsigned)
		9);        // NOLINT(build/unsigned)
	BOOST_REQUIRE_EQUAL(*(static_cast<uint8_t*>(deserialized.get_fragments_ref().at(1)->get_data()) + 5), // NOLINT(build/unsigned)
		10);        // NOLINT(build/unsigned
	BOOST_REQUIRE_EQUAL(*(static_cast<uint8_t*>(deserialized.get_fragments_ref().at(1)->get_data()) + 6), // NOLINT(build/unsigned)
		11);        // NOLINT(build/unsigned)
	BOOST_REQUIRE_EQUAL(*(static_cast<uint8_t*>(deserialized.get_fragments_ref().at(1)->get_data()) + 7), // NOLINT(build/unsigned)
...
BOOST_AUTO_TEST_CASE(Bad_JSON)
{
	...
	BOOST_REQUIRE_EXCEPTION(
		dunedaq::serialization::deserialize<TriggerRecord>(bytes), dunedaq::dfmessages::CannotDeserializeTriggerRecord, [&](dunedaq::dfmessages::CannotDeserializeTriggerRecord) { return true; });
	...
	BOOST_REQUIRE_EXCEPTION(
		dunedaq::serialization::deserialize<TriggerRecord>(more_bytes), dunedaq::dfmessages::CannotDeserializeTriggerRecordHeader, [&](dunedaq::dfmessages::CannotDeserializeTriggerRecordHeader) { return true; });
